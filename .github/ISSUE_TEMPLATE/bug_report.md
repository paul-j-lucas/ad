...
1. **Build-time issue**: you get either a compile-time error or warning while building **ad**.
2. **Run-time issue**: given particular input, **ad** either gives incorrect output or crashes.
...
**What was the input given to ad?**

(Please include **_only_** the input necessary to elicit the bug.)

**What output did you expect to be given by ad?**

**What output was actually given by ad?**

**If ad crashed, what was the crash message?**
