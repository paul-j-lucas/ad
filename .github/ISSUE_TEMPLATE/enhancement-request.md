...
about: Describe something ad currently doesn't do that you'd like it to — or does
...
**What doesn't ad currently do (or does do, but not in a way you'd like)?**

**What would you like ad to do (instead)?**
